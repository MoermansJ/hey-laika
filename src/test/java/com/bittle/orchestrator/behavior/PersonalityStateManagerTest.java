...
class PersonalityStateManagerTest {
    ...
    @Test
    void successfulActionAppliesImpactAndPosture() {
    ...
    @Test
    void failedActionChangesNothingButTheLog() {
        double energyBefore = state.energy();
    ...
    @Test
    void valuesAreClippedToUnitRange() {
        for (int i = 0; i < 10; i++) {
    ...
    @Test
    void sleepRestoresEnergyAndCapsBoredom() {
    ...
    @Test
    void passiveDriftRecoversEnergyWhileSleeping() {
    ...
    @Test
    void lonelinessGrowsHungerAfterThreshold() {
    ...
    @Test
    void ownerPettedRaisesHappinessAndRecordsInteraction() {
    ...
    @Test
    void pickedUpResyncsPostureToLying() {
        assertThat(state.posture()).isEqualTo(Posture.STANDING);
